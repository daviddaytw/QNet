...
\author{
    David Wei Day,\textsuperscript{\rm 1}
    Hao-Sheng Chen, \textsuperscript{\rm 2}
    Ming-Te Sun, \textsuperscript{\rm 3}
}
\affiliations{
    %Afiliations
    \textsuperscript{\rm 1\rm 2\rm 3}Department of Computer Science Department & Information Engineering, National Central University\\
